...
import com.paymybuddy.sendmoney.validator.UserValidator;
...
public class UserController {
     ...
     * 
     * public UserController(OAuth2AuthorizedClientService
     ...
     * 
     * @RolesAllowed("ADMIN") public String getAdmin() { return
     * "Welcome, admin";
     * 
     * }
     * 
     ...
     * "<br><br>"); protectedInfo.append("e-mail: " +
     ...
     * ":   " + claims.get(key) + "<br>"); } } else {
     * protectedInfo.append("NA"); } return protectedInfo; }
     * 
     * private StringBuffer getUsernamePasswordLoginInfo(Principal user) {
     * StringBuffer usernameInfo = new StringBuffer();
     * 
     * UsernamePasswordAuthenticationToken token =
     * ((UsernamePasswordAuthenticationToken) user); if
     * (token.isAuthenticated()) { User u = (User) token.getPrincipal();
     * usernameInfo.append("Welcome, " + u.getUsername()); } else {
     * usernameInfo.append("NA"); } return usernameInfo; }
     * 
     * private OidcIdToken getIdToken(OAuth2User principal) { if (principal
     * instanceof DefaultOidcUser) { DefaultOidcUser oidcUser =
     * (DefaultOidcUser) principal; return oidcUser.getIdToken(); } return null;
     * }
     */
}
